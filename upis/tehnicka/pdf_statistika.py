...
def pdf_racunajStatistiku(request, smjer_id):
    ...
    for ucenik in Ucenik.objects.filter(smjer=smjer):
        ...
        if not priznanja:
           ...
           priznanje_federalno_dict[ucenik.id]=0
            ...
            priznanje_ukupno_dict={}
            priznanje_ukupno_dict[ucenik.id]=priznanje_opcinsko_dict[ucenik.id]+ priznanje_kantonalno_dict[ucenik.id]+priznanje_federalno_dict[ucenik.id]
    ...
    return Render.render('tehnicka/pdf.html',context)
